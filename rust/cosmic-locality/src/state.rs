...
pub struct ShellState {
    pub incoming_requests: Arc<DashSet<Uuid>>,
    pub outgoing_requests: Arc<DashSet<Uuid>>
}

impl ShellState {
    pub fn new() -> Self {
        Self { incoming_requests: Arc::new(DashSet::new()),
        outgoing_requests: Arc::new(DashSet::new())}
    }
}
